...
# List of emotion columns (all except metadata/text columns)
...
# Create single 'emotion' label by choosing the emotion column with max value for each row
...
# Build pipeline with TF-IDF vectorizer and Logistic Regression classifier
pipe = Pipeline([
